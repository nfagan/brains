...
public:
	...
	bool in_bounds(ROI_INDICES::ROI_INDICES index) const;
	bool in_bounds_radius(ROI_INDICES::ROI_INDICES index, float radius) const;
  bool in_bounds_face(float dist) const;
